...
typedef struct {
    ...
    MLP* mlp2;                  // Second multi-layer perceptron layer
    ...
    float* d_mlp1_output;       // seq_len x batch_size x mlp1_output_dim (output from first MLP)
    ...
    float* d_mlp1_gradients;    // seq_len x batch_size x mlp1_output_dim (gradients for first MLP input)
