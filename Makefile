...
train.out: slm.o transformer.o attention.o mlp.o attn_data.o data.o train.o
	$(CC) slm.o transformer.o attention.o mlp.o attn_data.o data.o train.o $(CUDALIBS) $(LDFLAGS) -o $@
...
attn_data.o: transformer/attention/data.c transformer/attention/data.h
	$(CC) $(CFLAGS) $(CUDAFLAGS) -c transformer/attention/data.c -o $@
